  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3><?= $title?> <?php if (isset($id)): ?><a href="<?= my_library::admin_site()?>album/add"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> <?= lang('albumadd')?></button></a></h3><?php endif ?>
      </div>
              ...
              <?php if (isset($formDataLang['album_alias']) && isset($id)): ?>
                <div class="form-inline" style="margin-left: 10px;">
                  <div class="form-group">
                    ...
                    <code><?= base_url()?></code>
                    <input type="text" class="form-control" name="album_alias" value="<?= $formDataLang['album_alias']?>">
